...
export default function CustomerLayout() {
  ...
  const navItems = [
    ...
    { to: '/customer/currentTherapy', icon: NotepadText, label: 'Current Therapy' },
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      <aside className="w-64 bg-white border-r flex flex-col h-screen sticky top-0">
        ...
        <div className="p-4 border-b bg-gradient-to-r from-blue-50 to-cyan-50">
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 bg-gradient-to-r from-blue-500 to-cyan-500 text-white flex items-center justify-center rounded-full font-bold">
